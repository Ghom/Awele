...
class MousseController:
        """MouseController handle events coming from a mouse action and emmit 
...
class KeyboardController:
        ...
        or to control the Pygame display directly.
        """
        def __init__(self, event_manager):
            self.event_manager = event_manager
            self.event_manager.register_listener( self )
...
class CPUSpinnerController:
        """CPUSpinnerController emulate an event tick comming from the CPU.
        The main loop of the game is contained in the method run that send 
        TickEvent as fast as possible. 
        """
        def __init__(self, event_manager):
            self.event_manager = event_manager
            self.event_manager.register_listener( self )
